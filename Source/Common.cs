...
namespace LauncherWebzenV2.Source
{
    internal class Common
    {
        ...
        {
            Import.gMain.Status.Text = Texts.GetText(Key, Arguments);
        }
        ...
        public static void UpdateCompleteProgress(long Value)
        {
            ...
            Import.gMain.completeProgressText.Text = Texts.GetText("COMPLETEPROGRESS", Value);
            float num = (float)(650.0 * (Value / 100.0));
            Import.gMain.completeBar.Width = (int)num;
            Import.gMain.UpdatePanel.Update();
        }

        public static void UpdateCurrentProgress(
            long Value,
            double Speed)
        {
            if (Value < 0L || Value > 100L)
            ...
            Import.gMain.currentProgressText.Text = Texts.GetText("CURRENTPROGRESS", Value);
            float num = (float)(650.0 * (Value / 100.0));
        ...
        {
            Import.gMain.Btn_Run.BackgroundImage = Resources.Jugar_n;
        ...
        {
            Import.gMain.Btn_Run.BackgroundImage = Resources.Jugar_d;
